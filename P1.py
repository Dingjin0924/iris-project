...
# print(iris_data[0:5], iris_target[0:5], iris_columns)
...
# 分割資料為訓練集和測試集
X_train, X_teat, y_train, y_test = train_test_split(iris_data, iris_categorical_target, test_size=0.2, random_state=42)
